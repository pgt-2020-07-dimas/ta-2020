@extends('layouts.app', [
    'namePage' => 'Proyek Batal',
    'class' => 'login-page sidebar-mini ',
    'activePage' => 'proyek_batal',
...
<script>
  $(document).ready(function(){
    var str=  $("#search").val();
			...
			$.get( "{{ url('/batal/search?cari=') }}"+str, function( data ) {
			$( "#mydata" ).html( data );  
	    });
  ...
  $(document).ready(function(){
    ...
    var plant= $("#plant").val();
			...
			$.get( "{{ url('/batal/search?cari=') }}"+str+"&&"+"tahun="+tahun+"&&"+"plant="+plant, function( data ) {
			$( "#mydata" ).html( data );  
	    });
  ...
  $(document).ready(function(){
    ...
    var cari=  $("#search").val();
		...
		$.get( "{{ url('/batal/filter?tahun=') }}"+str+"&&"+"plant="+str1+"&&"+"cari="+cari, function( data ) {
			$( "#mydata" ).html( data );  
	  });
