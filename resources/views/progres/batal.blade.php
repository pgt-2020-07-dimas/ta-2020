      ...
      <div class="card ">
            <div class="card-header">
                ...
                <div class="text-right">
                    ...
                    <a href="/progres/batal/{{ $proyek->id }}" class="btn btn-primary btn-round">Detail Histori</a>
                    <a href="/batal" class="btn btn-info mr-3 btn-round">Kembali</a>
                </div> 
                </div>                      
        </div> 
