    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card pl-3">
          ...
          <div class="card-body">
            <form method="post" action="/pr" autocomplete="off" enctype="multipart/form-data">
            @method('post')
              @csrf
              ...
              <div class="row ">
                  <div class="col-md-10 pr-3">                  
                    <div class="form-group">
                      ...
                      <input type="text" name="pr_no" class="form-control @error('pr_no') is-invalid @enderror" value="{{ old('pr_no') }}">
              ...
              <div class="row">
                  <div class="col-md-10 pr-3">
                    <div class="form-group">
                      ...
                      <input type="date" name="aanwijzing_date" class="form-control @error('aanwijzing_date') is-invalid @enderror" value="{{ old('aanwijzing_date') }}" >
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-md-3 pr-5">
                    <input type="text" class="form-control text-center" placeholder="belum terisi" readonly>
                  </div>
                </div>
              <div class="card-footer mt-4">
                <button type="submit" name="submit" title="Simpan" class="btn btn-success btn-round">{{__('Simpan')}}</button>
