            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="#" class="btn btn-primary btn-xs" title="Edit Item" id="2-tasks-edit" icon="edit"><i class="fa fa-edit"></i> </a>
                        <a href="#" class="btn btn-danger btn-xs" title="Hapus Item" id="2-tasks-delete" icon="close"><i class="fa fa-close"></i> </a>
                    </td>
                </tr>
            </tbody>
        </table>
